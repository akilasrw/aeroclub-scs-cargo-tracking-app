...
class UnloadULDPage extends StatefulWidget {
  ...
  const UnloadULDPage({Key? key})
      : super(key: key);

  @override
  State<StatefulWidget> createState() => _UnloadULDPagePageState();
}

class _UnloadULDPagePageState extends State<UnloadULDPage> {
  Flight? flight = null;
                                            ...
                                            DateTimeField(
                                              ...
                                              onChanged: (value ){
                                                if(flight != null){
                                                  ...
                                                  data.getULDs(uldFlightSchedule,true);
                                                }
                                              },
...
/*  void showAlert(String msg) {
  ...
  void unloadULD(ULDLoadProvider data) async{
    bool isPacked = await data.unloadULD(selectedUld!);

    if(isPacked){
      showAlert("Success", "ULD unloaded successfully",true,redirectToHome);
    }
    else{
