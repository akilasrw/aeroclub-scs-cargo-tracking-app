...
//     //           var updatedToken = await _tokenRefreshRestClient!.refreshToken(
//     //               LoginResponse(token: _token!, refreshToken: _refreshToken!));
//     //           if (updatedToken.token != null && updatedToken.token.isNotEmpty) {
//     //             options?.headers["Authorization"] =
//     //             "Bearer ${updatedToken.token}";
//     //             var result = await _localStorage!.saveToken(updatedToken);
//     //             if (kDebugMode) {
//     //               print('refresh token $_refreshToken');
//     //               print('old token $_token');
//     //               print(
//     //                   'updated token ${updatedToken.token} token updated :$result');
//     //             }
//     //           } else {
