...
class _PickUpCargoMainDetailsState extends State<PickUpCargoMainDetailsPage> {
  ...
  Future<List<Airport>?> getAirports() async {
    try {
      var url = Uri.parse(
          "https://aeroclub-skytechcargo-app-dev-002.azurewebsites.net/api/v1/airport/getSelectList");
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<Airport>(
                            ...
                            items: list.map<DropdownMenuItem<Airport>>(
                                (Airport value) {
                          ...
                          ElevatedButton(
                              ...
                              onPressed: () {
                                var booking = Booking(
                                    ...
                                    null);
                                context.router
                                    .push(ScanCargoRoute(booking: booking));
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
